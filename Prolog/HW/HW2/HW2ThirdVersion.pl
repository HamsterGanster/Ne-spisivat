...
upath(Word1/PoS1/Sense1/SynSet1, Word2/PoS2/Sense2/SynSet2, [SynSetConnectionMore | Tail], Buff) :- 
    ...
    \+ memberchk(SynSetNext, Buff), % связи не было
    wn_s(SynSetNext, _, WordNext, PoSNext, SenseNext, _), % подборать слова, части речи и значение к SynSetNext
    SynSetConnectionMore = (Word1/PoS1/Sense1/SynSet1, Type, WordNext/PoSNext/SenseNext/SynSetNext),
    upath(WordNext/PoSNext/SenseNext/SynSetNext, Word2/PoS2/Sense2/SynSet2, Tail, [SynSetNext|Buff]). % рекурсивно искать и смотреть, что связи A не будет

hasConnection(All1, All2, Path) :- upath(All1, All2, Path, [All1]).

parseConnection([], []).
parseConnection([(Word1/PoS1/Sense1/SynSet1, X, Word2/PoS2/Sense2/SynSet2) | SynSetConnectionTail], [CurConnection | ConnectionTail]) :-
