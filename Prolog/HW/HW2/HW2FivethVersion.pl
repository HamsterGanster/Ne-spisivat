...
upath(Word1/PoS1/Sense1/SynSet1, Word2/PoS2/Sense2/SynSet2, [SynSetConnectionMore | Tail], Buff) :- 
    ...
    upath(AllNext, All2, Tail, [SynSetNext|Buff]). % рекурсивно искать и смотреть, что связи A не будет

hasConnection(Word1/PoS1/Sense1/SynSet1, All2, Path) :- upath(Word1/PoS1/Sense1/SynSet1, All2, Path, [SynSet1]).
...
related_words(Word1/PoS1/Sense1/SynSet1, Word2/PoS2/Sense2/SynSet2, MaxDist, Connection, SynSetConnectionMore) :-
    wn_s(SynSet1, _, Word1, PoS1, Sense1, _),
    wn_s(SynSet2, _, Word2, PoS2, Sense2, _),
